...
class Courses extends sequelize_1.Model {
    static associate(models) {
        ...
        Courses.belongsToMany(lecturerModel_1.default, { through: 'LecturerCourses', as: 'lecturers' });
        Courses.belongsTo(sessionModel_1.default, { foreignKey: 'session', as: 'courseSession' });
        Courses.belongsTo(semesterModel_1.default, { foreignKey: 'semester', as: 'courseSemester' });
    }
}
Courses.init({
    courseId: {
