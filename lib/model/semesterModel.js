...
class Semester extends sequelize_1.Model {
    static associate(models) {
        Semester.belongsTo(sessionModel_1.default, { foreignKey: 'sessionId', as: 'semesterSession' });
        Semester.hasMany(courseModel_1.default, { foreignKey: 'semester', as: 'semesterCourses' });
    }
}
Semester.init({
    semesterId: {
