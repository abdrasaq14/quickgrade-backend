...
// eslint-disable-next-line @typescript-eslint/no-misused-promises
router.get('/dashboard/take-exams/:courseCode', studentController_1.takeExam);
// eslint-disable-next-line @typescript-eslint/no-misused-promises
router.get('/dashboard/enrolled-courses', studentController_1.getExamTimetable);
// eslint-disable-next-line @typescript-eslint/no-misused-promises
router.get('/dashboard/get-results', studentController_1.getObjectivesScore);
// eslint-disable-next-line @typescript-eslint/no-misused-promises
router.put(
  '/dashboard/change-password',
  middleware_1.authenticateStudent,
  studentController_1.updateStudentPassword,
);
// eslint-disable-next-line @typescript-eslint/no-misused-promises
router.get('/dashboard/logout', studentController_1.logout);
