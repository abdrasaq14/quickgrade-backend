...
exports.verifyLecturerOTP =
  exports.sendLecturerOTP =
  exports.verifyStudentOTP =
  exports.sendStudentOTP =
    void 0;
...
const verifyStudentOTP = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const { otp } = req.body;
...
const verifyLecturerOTP = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const { otp } = req.body;
      const email = req.session.email;
