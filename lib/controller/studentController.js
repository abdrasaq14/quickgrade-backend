...
exports.updateStudentPassword = exports.resetPasswordToken = exports.resetPassword = exports.studentLogin = exports.verifyOTP = exports.studentSignup = void 0;
    ...
    try {
        ...
        if (existingStudent) {
            ...
            if (!createdStudent) {
                ...
                const studentDetail = yield studentModel_1.default.findOne({ where: { email } });
                if (!studentDetail) {
...
const studentLogin = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const email = existingStudent === null || existingStudent === void 0 ? void 0 : existingStudent.dataValues.email;
        req.session.email = email;
