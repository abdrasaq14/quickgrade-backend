...
exports.logout = exports.getObjectivesScore = exports.takeExam = exports.getExamTimetable = exports.getStudentDashboard = exports.updateStudentPassword = exports.resetPasswordToken = exports.resetPassword = exports.studentLogin = exports.verifyOTP = exports.studentSignup = void 0;
...
const takeExam = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const examsDetail = yield examModel_1.default.findOne({ where: { courseCode } });
...
const getObjectivesScore = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const result = findStudentResponse.reduce((acc, curr) => {
        ...
        const enrolledExam = yield studentResponseModel_1.default.findAll({
            where: {
                studentId,
                semester,
            },
        ...
        yield Promise.all(eachQuetionAllocatedMarks).then((StudentResult) => {
...
exports.getObjectivesScore = getObjectivesScore;
