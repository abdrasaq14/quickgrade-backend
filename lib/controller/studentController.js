...
<<<<<<< HEAD
exports.studentCoursesGrades = exports.getStudentDashboard = exports.updateStudentPassword = exports.resetPasswordToken = exports.resetPassword = exports.studentLogin = exports.verifyOTP = exports.studentSignup = void 0;
=======
exports.logout = exports.getExamTimetable = exports.getStudentDashboard = exports.updateStudentPassword = exports.resetPasswordToken = exports.resetPassword = exports.studentLogin = exports.verifyOTP = exports.studentSignup = void 0;
>>>>>>> 13e930c (updated-backend)
...
const studentSignupSchema = zod_1.z.object({
    firstName: zod_1.z.string().min(2).max(50),
    lastName: zod_1.z.string().min(2).max(50),
    faculty: zod_1.z.string().min(2).max(50),
...
const studentCoursesGrades = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const grades = yield gradingModel_1.default.findAll({
            ...
            where: {
                [sequelize_2.Op.and]: [
                    ...
                    sequelize_1.Sequelize.where(sequelize_1.Sequelize.fn('YEAR', sequelize_1.Sequelize.col('createdAt')), new Date().getFullYear()), // Match the current year
            ...
            include: [
                {
                    model: courseModel_1.default, // Specify the associated model (Courses)
...
exports.studentCoursesGrades = studentCoursesGrades;
=======
const getExamTimetable = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _d;
    try {
        const studentId = (_d = req.student) === null || _d === void 0 ? void 0 : _d.studentId;
        if (!studentId) {
            res.json({ message: 'unauthorized' });
        }
        else {
