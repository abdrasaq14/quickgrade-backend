...
exports.logout =
  exports.getObjectivesScore =
  exports.takeExam =
  exports.getExamTimetable =
...
const studentSignup = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const { firstName, lastName, faculty, email, department, password } =
        req.body;
      ...
      if (existingStudent) {
        ...
        const noOfStudent = ((yield studentModel_1.default.count()) + 1)
          .toString()
          .padStart(4, '0');
    ...
    try {
      ...
      if (!existingStudent) {
        ...
        const isPasswordValid = yield bcryptjs_1.default.compare(
          password,
          existingStudent.dataValues.password,
        );
        if (!isPasswordValid) {
          ...
          const token = jsonwebtoken_1.default.sign(
            { loginkey: existingStudent.dataValues.studentId },
            secret,
            { expiresIn: '1h' },
          );
...
const resetPasswordToken = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const user = yield studentModel_1.default.findOne({
...
const updateStudentPassword = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      // Find the user by ID
      const studentId =
        (_b = req.student) === null || _b === void 0 ? void 0 : _b.studentId;
...
const takeExam = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const { courseCode } = req.params;
      const questions = yield questionModel_1.default.findAll({
        where: { courseCode },
      });
      const examsDetail = yield examModel_1.default.findOne({
        where: { courseCode },
      });
...
const getObjectivesScore = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      // const { studentId } = req.body
      const { studentId, semester } = req.query;
      console.log('query:', req.query);
      const findStudentResponse = yield studentResponseModel_1.default.findAll({
