...
const lecturerLogin = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const existingLecturer = yield lecturerModel_2.default.findOne({ where: { lecturerId } });
        if (!existingLecturer) {
            return res.status(400).json({
                message: "Invalid lecturerId",
            });
        }
        const isPasswordValid = yield bcryptjs_1.default.compare(password, existingLecturer.password);
        if (!isPasswordValid) {
