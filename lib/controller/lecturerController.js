...
exports.getGradedExams = exports.getLecturerDashboard = exports.gradeExam = exports.setExamQuestions = exports.getCourses = exports.updateLecturerPassword = exports.verifyOTP = exports.resetPasswordToken = exports.resetPassword = exports.lecturerLogin = exports.lecturerSignup = void 0;
...
const verifyOTP = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (!lecturer) {
            ...
            yield lecturer.update({ isVerified: true, otp: null, otpExpiration: null, otpSecret: null });
...
const updateLecturerPassword = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        // Find the user by ID
        const user = yield lecturerModel_1.default.findByPk(studentId);
        if (!user) {
...
const setExamQuestions = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const { lecturerId, examDuration, instruction, courseTitle, courseCode, semester, session, faculty, department, examDate, totalScore, questions, sections } = req.body;
        ...
        const createdQuestions = yield Promise.all(questions.map((question) => __awaiter(void 0, void 0, void 0, function* () {
            try {
...
const gradeExam = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const semester = yield examModel_1.default.findOne({ attributes: ['semester'], where: { examId } });
        const studentResponse = yield Promise.all(assembledQuestions.map((response) => __awaiter(void 0, void 0, void 0, function* () {
            try {
                if (response.questionType === 'Objective') {
                    const correctAnswer = yield questionModel_1.default.findOne({ where: { questionId: response.questionId } });
                    return yield studentResponseModel_1.default.create({
                        studentId,
                        examId,
                        semester: semester === null || semester === void 0 ? void 0 : semester.dataValues.semester,
                        courseCode,
                        questionId: response.questionId,
                        responseText: response.questionText,
                        isCorrect: (correctAnswer === null || correctAnswer === void 0 ? void 0 : correctAnswer.dataValues.correctAnswer) === response.typedAnswer
                    });
                }
            }
            catch (error) {
        ...
        if (!studentResponse) {
            ...
            const findStudentResponse = yield studentResponseModel_1.default.findAll({ attributes: ['studentId', 'courseCode', 'examId', 'isCorrect'], where: { studentId } });
            ...
            const eachQuetionAllocatedMarks = Object.keys(result).map((key) => __awaiter(void 0, void 0, void 0, function* () {
                const course = yield examModel_1.default.findOne({ where: { courseCode: key } });
                console.log('course', course === null || course === void 0 ? void 0 : course.dataValues);
                if (course) {
            ...
            const studentResponseAutograding = yield Promise.all(eachQuetionAllocatedMarks);
...
const getGradedExams = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const checkExamQuestions = yield examModel_1.default.findAll({ where: { lecturerId } });
        ...
        yield Promise.all(firstSemester.map((eachStudentThatTookExam) => __awaiter(void 0, void 0, void 0, function* () {
            const examId = eachStudentThatTookExam.dataValues.examId;
            return yield gradingModel_1.default.findAll({ where: { examId } })
                .then((gradings) => __awaiter(void 0, void 0, void 0, function* () {
                return yield Promise.all(gradings.map((grading) => __awaiter(void 0, void 0, void 0, function* () {
                    const studentId = grading.dataValues.studentId;
                    return yield studentModel_1.default.findOne({ attributes: ['matricNo'], where: { studentId } })
                        .then(matricNo => {
                        var _a;
                        const returnedObject = Object.assign(Object.assign({}, grading.dataValues), { matricNo: (_a = matricNo === null || matricNo === void 0 ? void 0 : matricNo.dataValues.matricNo) !== null && _a !== void 0 ? _a : '' });
