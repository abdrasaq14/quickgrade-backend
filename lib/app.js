...
const examinationTimetable_Route_1 = __importDefault(require("./routes/examinationTimetable_Route"));
const verifyTokenRoute_1 = __importDefault(require("./routes/verifyTokenRoute"));
...
app.use('/departments', departmentRoute_1.default);
