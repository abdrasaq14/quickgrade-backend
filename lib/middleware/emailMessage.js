...
dotenv.config();
const emailMessage = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
            ...
            attachments: [
                {
                    ...
                    path: path_1.default.join(__dirname, '..', 'public/imges', 'python.jpeg'), // Corrected the path
                    contentType: 'application/pdf',
                },
                {
                    filename: 'python.jpeg',
                    path: path_1.default.join(__dirname, '..', 'public/images', 'python.jpeg'), // Corrected the path
        ...
        yield sendMail(transporter, mailOptions);
